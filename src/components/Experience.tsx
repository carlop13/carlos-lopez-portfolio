    ...
    <section className="py-24 px-6 max-w-5xl mx-auto" id="experience">
      ...
      <div className="flex flex-col gap-8">
        {portfolioData.experience.map((exp, index) => (
          <div key={index} className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_4px_20px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col md:flex-row gap-4 md:gap-12 hover:-translate-y-1 transition-transform duration-300">
            <div className="md:w-1/4 text-sm font-bold text-[#248277] pt-1 uppercase tracking-wider">
              {exp.period}
            </div>
